...
The US-only ballot contains all 19,440 valid combinations of six policy terms (17,280 when pausing AI is unavailable). International mode adds a trade choice, giving each side 38,880 combinations (34,560 without a pause). The current-policy package remains on the US ballot:
